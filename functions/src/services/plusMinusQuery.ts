...
export const useSaveNewQuestions = async (data: QuestionType[], correctRate: string) => {
...
export const useUpdateQuestions = async (data: QuestionType[], correctRate: string, id: string) =>
